...
export default class Toolbar extends React.Component {
  ...
  static _defaultItemOptions(element) {
    switch (element) {
      case 'Dropdown':
        return [
          { value: 'place_holder_option_1', text: 'گزینه 1', key: `dropdown_option_${ID.uuid()}` },
          { value: 'place_holder_option_2', text: 'گزینه 2', key: `dropdown_option_${ID.uuid()}` },
          { value: 'place_holder_option_3', text: 'گزینه 3', key: `dropdown_option_${ID.uuid()}` },
        ];
      case 'Tags':
        return [
      ...
      case 'Checkboxes':
        return [
          { value: 'place_holder_option_1', text: 'گزینه 1', key: `checkboxes_option_${ID.uuid()}` },
          { value: 'place_holder_option_2', text: 'گزینه 2', key: `checkboxes_option_${ID.uuid()}` },
          { value: 'place_holder_option_3', text: 'گزینه 3', key: `checkboxes_option_${ID.uuid()}` },
        ];
      case 'RadioButtons':
        return [
          { value: 'place_holder_option_1', text: 'گزینه 1', key: `radiobuttons_option_${ID.uuid()}` },
          { value: 'place_holder_option_2', text: 'گزینه 2', key: `radiobuttons_option_${ID.uuid()}` },
          { value: 'place_holder_option_3', text: 'گزینه 3', key: `radiobuttons_option_${ID.uuid()}` },
        ];
      default:
        return [];
    }
